...
ui <- function(request) {
  tagList(
    shiny::h1("Song Statistics HQ", style = "font-size: 28px; margin-left: 15px;"),
    shiny::fluidPage(
      shinyjs::useShinyjs(),
      ...
      shiny::column(2,
                    ...
                    shinyBS::bsPopover(
                      ...
                      title = "Max Train Gap",
                      content = shiny::HTML(paste0("Maximum gap allowed between trains to be considered in the same motif. If the gap exceeds this value, a new motif is initialized")),
                      placement = "right",
                      trigger = "click",
                      options = list(container = "body")
                    ),
